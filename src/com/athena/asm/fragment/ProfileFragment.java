...
public class ProfileFragment extends SherlockFragment implements
	...
	public void reloadProfile() {
		if (m_currentProfile == null) {
			...
			ImageButton searchButton = (ImageButton) m_layout
				...
				public void onClick(View v) {
					...
					if (idString.length() > 0) {
						LoadProfileTask profileTask = new LoadProfileTask(
								getActivity(), m_viewModel, idString);
						profileTask.execute();
					}
			...
			TextView userIDTextView = (TextView) m_layout
					.findViewById(R.id.profile_userid);
			userIDTextView.setText(m_currentProfile.getUserID());

			TextView userScoreTextView = (TextView) m_layout
